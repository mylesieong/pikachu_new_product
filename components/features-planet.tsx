        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              Build a functional product from start to finish. Gain hands-on experience by creating something tangible, so you’re job-ready with projects you can showcase in your portfolio.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Work collaboratively in small squads under the guidance of senior engineers. Learn the dynamics of teamwork, problem-solving, and communication—essential skills in any tech job.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Fast-Track to a Career</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              In just 3 weeks, you'll gain the practical skills needed to switch careers or advance in tech. No fluff—only focused, hands-on coding to get you job-ready in record time.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Mentorship by Experts</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Benefit from direct mentorship from experienced senior engineers. Get personalized guidance, feedback, and insight into the real-world processes of software development.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Agile Focus</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Learn the core principles of Agile and SCRUM methodologies while developing your product. This skill set is highly sought after by employers in today’s tech industry.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Beyond coding, we offer guidance on building your resume, preparing for technical interviews, and connecting with potential employers. We're here to help you land your next tech job!
              </p>
            </article>
          </div>
        </div>
